...
[**raw_dataset_facet**](RawDatasetApi.md#raw_dataset_facet) | **GET** /RawDatasets/facet | Find all datasets within a date range
...
# **raw_dataset_facet**
> InlineResponse2003 raw_dataset_facet(creationLocation=creationLocation, ownerGroup=ownerGroup, startDate=startDate, endDate=endDate)
...
# create an instance of the API class
api_instance = swagger_client.RawDatasetApi()
creationLocation = 'creationLocation_example' # str |  (optional)
ownerGroup = 'ownerGroup_example' # str |  (optional)
startDate = 'startDate_example' # str |  (optional)
endDate = 'endDate_example' # str |  (optional)

try: 
    # Find all datasets within a date range
    api_response = api_instance.raw_dataset_facet(creationLocation=creationLocation, ownerGroup=ownerGroup, startDate=startDate, endDate=endDate)
    pprint(api_response)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **creationLocation** | **str**|  | [optional] 
 **ownerGroup** | **str**|  | [optional] 
