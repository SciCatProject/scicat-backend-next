...
[**dataset_facet**](DatasetApi.md#dataset_facet) | **POST** /Datasets/facet | Search for numbers associated with dataset properties. I.e. How many datasets in Group A. Default returns: Creation Location, Owner Groups and Creation Time
...
[**dataset_is_valid**](DatasetApi.md#dataset_is_valid) | **POST** /Datasets/isValid | Check if data is valid according to a schema
