...
[**job_patch_or_create_patch_jobs**](JobApi.md#job_patch_or_create_patch_jobs) | **PATCH** /Jobs | Patch an existing model instance or insert a new one into the data source.
[**job_patch_or_create_put_jobs**](JobApi.md#job_patch_or_create_put_jobs) | **PUT** /Jobs | Patch an existing model instance or insert a new one into the data source.
[**job_prototype_patch_attributes_patch_jobsid**](JobApi.md#job_prototype_patch_attributes_patch_jobsid) | **PATCH** /Jobs/{id} | Patch attributes for a model instance and persist it into the data source.
[**job_prototype_patch_attributes_put_jobsid**](JobApi.md#job_prototype_patch_attributes_put_jobsid) | **PUT** /Jobs/{id} | Patch attributes for a model instance and persist it into the data source.
[**job_replace_by_id**](JobApi.md#job_replace_by_id) | **POST** /Jobs/{id}/replace | Replace attributes for a model instance and persist it into the data source.
[**job_replace_or_create**](JobApi.md#job_replace_or_create) | **POST** /Jobs/replaceOrCreate | Replace an existing model instance or insert a new one into the data source.
...
# **job_patch_or_create_patch_jobs**
> Job job_patch_or_create_patch_jobs(data=data)
...
try: 
    # Patch an existing model instance or insert a new one into the data source.
    api_response = api_instance.job_patch_or_create_patch_jobs(data=data)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling JobApi->job_patch_or_create_patch_jobs: %s\n" % e)
```
...
# **job_patch_or_create_put_jobs**
> Job job_patch_or_create_put_jobs(data=data)
...
try: 
    # Patch an existing model instance or insert a new one into the data source.
    api_response = api_instance.job_patch_or_create_put_jobs(data=data)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling JobApi->job_patch_or_create_put_jobs: %s\n" % e)
```
...
# **job_prototype_patch_attributes_patch_jobsid**
> Job job_prototype_patch_attributes_patch_jobsid(id, data=data)
...
try: 
    # Patch attributes for a model instance and persist it into the data source.
    api_response = api_instance.job_prototype_patch_attributes_patch_jobsid(id, data=data)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling JobApi->job_prototype_patch_attributes_patch_jobsid: %s\n" % e)
```
...
# **job_prototype_patch_attributes_put_jobsid**
> Job job_prototype_patch_attributes_put_jobsid(id, data=data)
...
try: 
    # Patch attributes for a model instance and persist it into the data source.
    api_response = api_instance.job_prototype_patch_attributes_put_jobsid(id, data=data)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling JobApi->job_prototype_patch_attributes_put_jobsid: %s\n" % e)
```
...
# **job_replace_by_id**
> Job job_replace_by_id(id, data=data)
...
try: 
    # Replace attributes for a model instance and persist it into the data source.
    api_response = api_instance.job_replace_by_id(id, data=data)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling JobApi->job_replace_by_id: %s\n" % e)
```
...
# **job_replace_or_create**
> Job job_replace_or_create(data=data)
...
try: 
    # Replace an existing model instance or insert a new one into the data source.
    api_response = api_instance.job_replace_or_create(data=data)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling JobApi->job_replace_or_create: %s\n" % e)
```
