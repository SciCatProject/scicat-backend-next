...
class Datafile(object):
    ...
    """
    def __init__(self, path=None, size=None, time=None, sha=None, uid=None, gid=None, perm=None):
        """
    ...
    def time(self):
        ...
        Time of file creation on disk, format according to chapter 5.6 internet date/time format in RFC 3339
    ...
    def sha(self):
        """
        Gets the sha of this Datafile.
        Checksum for the file, e.g. sha-2

        :return: The sha of this Datafile.
        :rtype: str
        """
        return self._sha
    ...
    def sha(self, sha):
        """
        Sets the sha of this Datafile.
        Checksum for the file, e.g. sha-2

        :param sha: The sha of this Datafile.
        :type: str
        """
