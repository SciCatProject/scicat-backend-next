...
class Job(object):
    ...
    """
    def __init__(self, emailJobInitiator=None, type='retrieve', creationTime=None, executionTime=None, jobParams=None, jobStatusMessage=None, datasetList=None, id=None, createdAt=None, updatedAt=None):
        """
