...
class Dataset(object):
    ...
    def pid(self):
        ...
        :return: The pid of this Dataset.
        :rtype: str
        """
        return self._pid
    ...
    def pid(self, pid):
        ...
        :param pid: The pid of this Dataset.
        :type: str
        """
        if pid is None:
    ...
    def ownerEmail(self):
        """
        Gets the ownerEmail of this Dataset.
        Email of owner of the data set

        :return: The ownerEmail of this Dataset.
        :rtype: str
        """
    ...
    def ownerEmail(self, ownerEmail):
        """
        Sets the ownerEmail of this Dataset.
        Email of owner of the data set

        :param ownerEmail: The ownerEmail of this Dataset.
        :type: str
        """
    ...
    def orcidOfOwner(self):
        """
        Gets the orcidOfOwner of this Dataset.
        ORCID of owner https://orcid.org if available

        :return: The orcidOfOwner of this Dataset.
        :rtype: str
        """
    ...
    def orcidOfOwner(self, orcidOfOwner):
        """
        Sets the orcidOfOwner of this Dataset.
        ORCID of owner https://orcid.org if available

        :param orcidOfOwner: The orcidOfOwner of this Dataset.
        :type: str
        """
    ...
    def contactEmail(self):
        """
        Gets the contactEmail of this Dataset.
        Email of contact person for this dataset

        :return: The contactEmail of this Dataset.
        :rtype: str
        """
    ...
    def contactEmail(self, contactEmail):
        """
        Sets the contactEmail of this Dataset.
        Email of contact person for this dataset

        :param contactEmail: The contactEmail of this Dataset.
        :type: str
        """
    ...
    def sourceFolder(self):
        """
        Gets the sourceFolder of this Dataset.
        ...
        :return: The sourceFolder of this Dataset.
        :rtype: str
        """
    ...
    def sourceFolder(self, sourceFolder):
        """
        Sets the sourceFolder of this Dataset.
        Absolute file path on file server containing the files of this dataset, optionally including protocol and file server hostname, e.g. nfs://fileserver1.example.com/some/path/to/sourcefolder. In case of a single file dataset, e.g. HDF5 data file the string can also be the full path to this single file.

        :param sourceFolder: The sourceFolder of this Dataset.
        :type: str
        """
    ...
    def packedSize(self):
        """
        Gets the packedSize of this Dataset.
        Total size of all datablock package files created for this dataset

        :return: The packedSize of this Dataset.
        :rtype: float
        """
    ...
    def packedSize(self, packedSize):
        """
        Sets the packedSize of this Dataset.
        Total size of all datablock package files created for this dataset

        :param packedSize: The packedSize of this Dataset.
        :type: float
        """
    ...
    def creationTime(self):
        """
        Gets the creationTime of this Dataset.
        ...
        :return: The creationTime of this Dataset.
        :rtype: datetime
        """
    ...
    def creationTime(self, creationTime):
        """
        Sets the creationTime of this Dataset.
        Time when dataset became fully available on disk, i.e. all containing files have been written. Format according to chapter 5.6 internet date/time format in RFC 3339. Local times without timezone/offset info are automatically transformed to UTC using the timezone of the API server.

        :param creationTime: The creationTime of this Dataset.
        :type: datetime
        """
    ...
    def validationStatus(self, validationStatus):
        """
        Sets the validationStatus of this Dataset.
        Defines a level of trust, e.g. a measure of how much data was verified or used by other persons

        :param validationStatus: The validationStatus of this Dataset.
        :type: str
        """
    ...
    def userTargetLocation(self):
        """
        Gets the userTargetLocation of this Dataset.
        ...
        :return: The userTargetLocation of this Dataset.
        :rtype: str
        """
    ...
    def userTargetLocation(self, userTargetLocation):
        """
        Sets the userTargetLocation of this Dataset.
        User choosable absolute virtual path where datasets are stored. Mainly used as a help for the enduser at dataset retrieval time to find the proper dataset. Will be prepended by p-group

        :param userTargetLocation: The userTargetLocation of this Dataset.
        :type: str
        """
    ...
    def classification(self):
        """
        Gets the classification of this Dataset.
        ...
        :return: The classification of this Dataset.
        :rtype: str
        """
    ...
    def classification(self, classification):
        ...
        :param classification: The classification of this Dataset.
        :type: str
        """
    ...
    def license(self):
        """
        Gets the license of this Dataset.
        Name of license under which data can be used

        :return: The license of this Dataset.
        :rtype: str
        """
    ...
    def isPublished(self):
        """
        Gets the isPublished of this Dataset.
        Flag is true when data are made publically available

        :return: The isPublished of this Dataset.
        :rtype: bool
        """
    ...
    def isPublished(self, isPublished):
        """
        Sets the isPublished of this Dataset.
        Flag is true when data are made publically available

        :param isPublished: The isPublished of this Dataset.
        :type: bool
        """
    ...
    def ownerGroup(self, ownerGroup):
        """
        Sets the ownerGroup of this Dataset.
        Defines the group which owns the data, and therefore has unrestricted access to this data. Usually a pgroup like p12151

        :param ownerGroup: The ownerGroup of this Dataset.
        :type: str
        """
    ...
    def accessGroups(self):
        """
        Gets the accessGroups of this Dataset.
        ...
        :return: The accessGroups of this Dataset.
        :rtype: list[str]
        """
    ...
    def accessGroups(self, accessGroups):
        """
        Sets the accessGroups of this Dataset.
        Optional additional groups which have read access to the data. Users which are member in one of the groups listed here are allowed to access this data. The special group 'public' makes data available to all users

        :param accessGroups: The accessGroups of this Dataset.
        :type: list[str]
        """
    ...
    def createdBy(self):
        ...
        :return: The createdBy of this Dataset.
        :rtype: str
        """
    ...
    def updatedBy(self):
        """
        Gets the updatedBy of this Dataset.
        Functional or user account name who last updated this instance

        :return: The updatedBy of this Dataset.
        :rtype: str
        """
    ...
    def updatedBy(self, updatedBy):
        """
        Sets the updatedBy of this Dataset.
        Functional or user account name who last updated this instance

        :param updatedBy: The updatedBy of this Dataset.
        :type: str
        """
    ...
    def createdAt(self):
        """
        Gets the createdAt of this Dataset.

        :return: The createdAt of this Dataset.
        :rtype: datetime
        """
    ...
    def createdAt(self, createdAt):
        """
        Sets the createdAt of this Dataset.

        :param createdAt: The createdAt of this Dataset.
        :type: datetime
        """
    ...
    def updatedAt(self):
        """
        Gets the updatedAt of this Dataset.

        :return: The updatedAt of this Dataset.
        :rtype: datetime
        """
    ...
    def updatedAt(self, updatedAt):
        """
        Sets the updatedAt of this Dataset.

        :param updatedAt: The updatedAt of this Dataset.
        :type: datetime
        """
