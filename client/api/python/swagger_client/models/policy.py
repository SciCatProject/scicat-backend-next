...
class Policy(object):
    ...
    """
    def __init__(self, availability='low', tapeRetentionTime=10.0, autoArchiveDelay=7.0, ownerGroup=None, accessGroups=None, id=None, createdAt=None, updatedAt=None):
        """
