...
class RawDataset(object):
    ...
    def endTime(self):
        ...
        Time of end of data taking for this dataset, format according to chapter 5.6 internet date/time format in RFC 3339
