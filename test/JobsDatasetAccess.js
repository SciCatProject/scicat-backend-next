...
describe("1140: Jobs: Test New Job Model Authorization for #dataset_access jobs configuration", () => {
  before(() => {
  ...
  it("0110: Adds a new job as user1 for user5.1 ownerUser and group5 ownerGroup for #datasetAccess, which should fail", async () => {
    const newJob = {
      ...jobDatasetAccess,
      ownerUser: "user5.1",
      ownerGroup: "group5",
