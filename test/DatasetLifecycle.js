...
describe('Test DatasetLifecycle and the relation to Datasets', () => {
    ...
    it('Should return datasets with complex join query fulfilled', function(done) {
        ...
        request(app)
            .get('/api/v2/Datasets/fullquery?fields=' + encodeURIComponent(JSON.stringify(fields)) + '&access_token=' + accessTokenIngestor)
            .set('Accept', 'application/json')
            .expect(200)
            .expect('Content-Type', /json/)
            .end((err, res) => {
    ...
    it('Should return datasets with ordered results', function(done) {
        ...
        request(app)
            .get('/api/v2/Datasets/fullquery?fields=' + encodeURIComponent(JSON.stringify(fields)) + '&limits=' + encodeURIComponent(JSON.stringify(limits)) + '&access_token=' + accessTokenIngestor)
            .set('Accept', 'application/json')
            .expect(200)
            .expect('Content-Type', /json/)
            .end((err, res) => {
    ...
    it('Should return facets with complex join query fulfilled', function(done) {
        ...
        request(app)
            .get('/api/v2/Datasets/fullfacet?fields=' + encodeURIComponent(JSON.stringify(fields)) + '&facets=' + encodeURIComponent(JSON.stringify(facets))+ '&access_token=' + accessTokenIngestor)
            .set('Accept', 'application/json')
            .expect(200)
            .expect('Content-Type', /json/)
            .end((err, res) => {
    ...
    it('should delete the other DatasetLifecycle', function(done) {
        request(app)
            .delete('/api/v2/DatasetLifecycles/' + idDatasetLifecycle2 + '?access_token=' + accessTokenIngestor)
            .set('Accept', 'application/json')
            .expect(200)
            .expect('Content-Type', /json/)
            .end((err, res) => {
    ...
    it('should delete the newly created dataset', function(done) {
        request(app)
            .delete('/api/v2/Datasets/' + pid2 + '?access_token=' + accessTokenIngestor)
            .set('Accept', 'application/json')
            .expect(200)
            .expect('Content-Type', /json/)
            .end((err, res) => {
