...
describe.only("1120: Jobs: Test New Job Model Authorization for admin_access jobs type", () => {
  before(() => {
  ...
  it("0120: Add a new job as a user from CREATE_JOB_GROUPS for himself/herself in '#all' configuration, which should fail as forbidden", async () => {
    const newJob = {
      ...jobAll,
      ownerUser: "user1",
      ownerGroup: "group1",
  ...
  it("0130: Add a new job as a user from CREATE_JOB_GROUPS for his/her group in '#all' configuration, which should fail as forbidden", async () => {
    const newJob = {
      ...jobAll,
      ownerGroup: "group1",
      jobParams: {
  ...
  it("0140: Add a new job as a user from CREATE_JOB_GROUPS for another user in '#all' configuration, which should fail as forbidden", async () => {
    const newJob = {
      ...jobAll,
      ownerUser: "user5.1",
      ownerGroup: "group5",
  ...
  it("0150: Add a new job as a user from CREATE_JOB_GROUPS for another group in '#all' configuration, which should fail as forbidden", async () => {
    const newJob = {
      ...jobAll,
      ownerGroup: "group5",
      jobParams: {
  ...
  it("0160: Add a new job as a user from CREATE_JOB_GROUPS for anonymous user in '#all' configuration, which should fail as forbidden", async () => {
    const newJob = {
      ...jobAll,
      jobParams: {
        datasetList: [
