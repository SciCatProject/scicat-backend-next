...
//         request(app)
//             .post('/api/v3/DatasetLifecycles?access_token=' + accessTokenIngestor)
...
//         request(app)
//             .post('/api/v3/DatasetLifecycles/' + idDatasetLifecycle + '/messageHistory?access_token=' + accessTokenIngestor)
//             .send(newMessage)
//             .set('Accept', 'application/json')
//             .expect(200)
//             .expect('Content-Type', /json/)
...
//         request(app)
//             .get('/api/v3/DatasetLifecycles/' + idDatasetLifecycle + '?access_token=' + accessTokenIngestor)
//             .set('Accept', 'application/json')
//             .expect(200)
//             .expect('Content-Type', /json/)
//             .end(function(err, res) {
...
//         request(app)
//             .delete('/api/v3/DatasetLifecycles/' + idDatasetLifecycle + '?access_token=' + accessTokenIngestor)
//             .set('Accept', 'application/json')
//             .expect(200)
//             .expect('Content-Type', /json/)
//             .end((err, res) => {
