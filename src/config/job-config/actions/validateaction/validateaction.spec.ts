...
describe("ValidateAction", () => {
  describe("request validation", () => {
    let action: ValidateJobAction<CreateJobDto>;
    ...
    beforeAll(() => {
      ...
      action = new ValidateJobAction<CreateJobDto>(config);
    });
  ...
  describe("dataset validation", () => {
    let creator: ValidateCreateJobActionCreator;
    let action: ValidateCreateJobAction;
