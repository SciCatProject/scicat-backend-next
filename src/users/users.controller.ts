...
export class UsersController {
  ...
  async findById(
    ...
    await this.checkUserAuthorization(request, [Action.UserReadAny, Action.UserReadOwn], id); 
  ...
  async createSettings(
    ...
    await this.checkUserAuthorization(request, [Action.UserCreateAny, Action.UserCreateOwn], id); 
  ...
  async updateSettings(
    ...
    await this.checkUserAuthorization(request, [Action.UserUpdateAny, Action.UserUpdateOwn], id); 
  ...
  async canUserCreateDataset(
    ...
    await this.checkUserAuthorization(request, [Action.UserReadAny, Action.UserReadOwn], id);
    const viewedUser = await this.usersService.findById2JWTUser(id) as JWTUser;
