...
export type PublishedDataV4Document = PublishedDataV4 & Document;
...
export class PublishedDataV4 extends QueryableClass {
  @Prop({
    type: String,
  })
  _id: string;
...
export const PublishedDataV4Schema =
  SchemaFactory.createForClass(PublishedDataV4);

PublishedDataV4Schema.index({ "$**": "text" });
