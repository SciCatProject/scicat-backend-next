import { ValidateAction, ValidateCreateAction } from "./validateaction";
...
describe("ValidateAction", () => {
  describe("request validation", () => {
    let action: ValidateAction<CreateJobDto>;
    ...
    beforeAll(() => {
      ...
      action = new ValidateAction<CreateJobDto>(config);
    });
  ...
  describe("dataset validation", () => {
    ...
    let action: ValidateCreateAction;
    ...
    beforeAll(async () => {
        ...
        providers: [
          ...
          },
          {
            ...
            useFactory: () => {
              ...
              return new ValidateCreateAction(config);
            },
          },
        ],
      }).compile();
      ...
      action = module.get<ValidateCreateAction>(ValidateCreateAction);
      // TODO shouldn't nest inject this manually?
      action["datasetsService"] = service;
    });
